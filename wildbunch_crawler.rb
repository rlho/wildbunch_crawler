...
class WildBunchCrawler
  def execute
    ...
    toyoko_in = Parse.new(site_name: '東横イン', url: 'https://www.toyoko-inn.com/search/result?chck_in=2018/07/29&inn_date=1&rsrv_num=1&sel_ldgngPpl=2&sel_area=42&sel_area_txt=%E5%B1%B1%E5%8F%A3&sel_htl=&rd_smk=&sel_room_clss_Id=&sel_prkng=&sel_cnfrnc=&sel_hrtfll_room=&sel_whlchr=&sel_bath=&sel_rstrnt=&srch_key_word=&lttd=&lngtd=&pgn=1&sel_dtl_cndtn=on&prcssng_dvsn=dtl&', xpath: '//div[@class="listHead mt20"]/p[@class="txtMessage"]')
